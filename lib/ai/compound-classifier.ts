  ...
  return JSON.stringify(
    {
      ...
      rules: [
        ...
        "Do not skip solely because a marketing term appears (for example blend/stack/complex); require evidence of multiple active compounds.",
        "Strong multi-compound evidence includes multiple peptide names or separators such as '+' '/' '&' between distinct actives.",
        "Treat qualifiers such as dosage, formulation, and modifiers like 'with DAC'/'no DAC' as part of a single-compound name unless another active compound is present.",
        "If blend indicators exist but multi-compound evidence is weak, prefer decision='review' over an unsafe skip or match.",
        "Ignore storefront noise such as prices and CTA fragments like 'add to cart', 'select options', and similar UI text.",
        "Vendors may euphemize compounds (for example retatrutide as 'RT'/'GLP-3' and tirzepatide as 'TZ'/'tirz', sometimes with vendor prefixes like 'ER-RT' or 'GLP-1 TZ'); use allowed compounds plus context to infer safe matches.",
